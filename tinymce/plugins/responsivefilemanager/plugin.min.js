...
tinymce.PluginManager.add('responsivefilemanager', function(editor) {
	...
	function openmanager(callback, value, meta) {
		...
		if (meta.filetype === 'file' || meta.mediaType === 'file') { urltype=2; }
	...
	function explorer(callback) {
		...
		var dialogUrl = editor.getParam('external_filemanager_path')+'dialog.php?type='+'4'+'&descending='+descending+sort_by+fldr+crossdomain+'&lang='+editor.getParam('language')+'&akey='+akey;
	...
	if (tinymce.majorVersion < 5) {
		...
		editor.addShortcut('Ctrl+E', '', explorer);
	}
});
